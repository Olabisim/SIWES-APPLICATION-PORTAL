...
if(isset($_GET['id'])) {
    ...
    if(empty($name)) {
        ...
        header("Location: ../middle_index.php?error=email  is required&$user_data"); 
    }
    ...
    // }
        ...
        $sql = "UPDATE report
                ...
                SET name='$name', matric_no='$matric_no', department='$department', email='$email', start_month='$start_month', end_month='$end_month', mode_of_entry='$mode_of_entry'
                WHERE id=$id";
